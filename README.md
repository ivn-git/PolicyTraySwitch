...
3. Запустите установщик и следуйте инструкциям на экране.
   * *Примечание:* Также вы можете скачать портативную версию (`PolicyTraySwitchPortable.zip`), распаковать и запускать на ПК
...
<img src="images/PortForwarding.png" alt="Настройка Port Forwarding" width="362">
